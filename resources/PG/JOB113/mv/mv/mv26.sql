create materialized view if not exists mv26 as select info_type.info AS info_type_info_0, movie_info_idx.info AS movie_info_idx_info_1, movie_info_idx.movie_id AS movie_id
