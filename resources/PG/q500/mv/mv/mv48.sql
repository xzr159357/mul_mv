create materialized view if not exists mv48 as select cast_info.movie_id AS movie_id, cast_info.person_id AS person_id, movie_info_idx.info_type_id AS info_type_id
