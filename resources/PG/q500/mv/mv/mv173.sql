create materialized view if not exists mv173 as select cast_info.movie_id AS movie_id, movie_keyword.keyword_id AS keyword_id, title.production_year AS production_year
