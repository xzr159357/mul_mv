create materialized view if not exists mv29 as select movie_companies.movie_id AS movie_id, title.kind_id AS kind_id, title.production_year AS production_year
