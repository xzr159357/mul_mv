create materialized view if not exists mv135 as select cast_info.movie_id AS movie_id, cast_info.role_id AS role_id, movie_companies.company_type_id AS company_type_id
