create index movie_id_mv527 on mv527(movie_id);
create index person_id_mv527 on mv527(person_id);
create index company_name_id_3_mv527 on mv527(company_name_id_3);
